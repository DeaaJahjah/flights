...
import 'package:flights/utils/hard_coded_data.dart';
...
class _AvailableFlightsPageState extends State<AvailableFlightsPage> {
  ...
  Widget _buildFlightCard(int itemIndex, String flightNumber) => ElevatedButton(
        style: ElevatedButton.styleFrom(
          backgroundColor: HardCodedData.availableFlights[itemIndex].flightNumber == flightNumber
        ...
        onPressed: () {
          _selectedFlight.value = HardCodedData.availableFlights[itemIndex].flightNumber;
