...
class _FadingItemListState extends State<FadingItemList> with TickerProviderStateMixin {
  ...
  void _initValues() {
    for (int i = 0; i < widget.listItems.length; i++) {
      ...
      widget.fadingItemListController.controllers = _listItemsMap.values.map((e) => e.animationController).toList();
    }
  }
