...
class R {
  static const Color _primaryColor = Color(0xFF435C5A);
  static const Color _secondaryColor = Color(0xFFFECEA5);
  static const Color _tertiaryColor = Color(0xFF93ADAB);
