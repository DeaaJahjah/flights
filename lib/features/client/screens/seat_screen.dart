            ...
            children: [
                  ...
                  Expanded(
                    child: Container(
                      ...
                      decoration: const BoxDecoration(
                          borderRadius: BorderRadius.vertical(top: Radius.circular(100)), color: Color(0xff597672)),
                    ),
                  ),
                ],
              ),
              Column(
                children: [
                  ...
                  TextUtil(
                    text: "${flightList[0].date} ${flightList[0].boardingTime}",
                    color: Colors.white,
                    size: 12,
                    weight: true,
                  ),
                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                              color: selectedSeat.isNotEmpty
                                                  ? selectedSeat[0] == j && selectedSeat[1] == i
          ...
          Column(
            ...
            children: [
              Column(
                ...
                children: [
                  TextUtil(
                    text: flightList[0].source,
                    color: Theme.of(context).indicatorColor,
                    size: 28,
                  ),
                  TextUtil(
                    text: flightList[0].sourceName,
                    color: Colors.white,
                    size: 12,
                    weight: true,
                  )
              ...
              Column(
                ...
                children: [
                  selectedSeat.isEmpty
                      ? const SizedBox()
                      : TextUtil(
                          text: "${selectedSeat[0]}${selectedSeat[1]}",
                          color: Theme.of(context).indicatorColor,
                          size: 28,
                        ),
                  TextUtil(
