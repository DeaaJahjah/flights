import 'package:flights/main_pages/add_flight_page_controller.dart';
import 'package:flights/sub_pages/checkout_page.dart';
import 'package:flights/sub_pages/seat_selection_page.dart';
import 'package:flights/widgets/custom_tab_bar/custom_tab_bar.dart';
import 'package:flights/widgets/custom_tab_bar/custom_tab_bar_controller.dart';
...
class _AddFlightPageState extends State<AddFlightPage> {
  ...
  void initState() {
    ...
    _pages = [
      RouteSelectionPage(
        isSelectionCompleted: (isCompleted) => widget.isSingleTabSelectionCompleted?.call(isCompleted),
      ),
  ...
  Widget build(BuildContext context) => Padding(
        ...
        child: Column(
          children: [
            CustomTabBar(
              customTabBarController: widget.addFlightPageController.customTabBarController,
            ),
            const SizedBox(
              height: 32.0,
            ),
